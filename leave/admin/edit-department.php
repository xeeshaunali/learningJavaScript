                ...
                <div class="row align-items-center">
                    <div class="col-sm-6">
                        <div class="breadcrumbs-area clearfix">
                            <h4 class="page-title pull-left">Court Section</h4>
                            <ul class="breadcrumbs pull-left">
                                <li><a href="department.php">Court</a></li>
                        ...
                        <?php if($error){?><div class="alert alert-danger alert-dismissible fade show"><strong>Info: </strong><?php echo htmlentities($error); ?>
                                ...
                                <form method="POST">
                                 <div class="card-body">
                                        ...
                                        <p class="text-muted font-14 mb-4">Please make changes on the form below in order to update Court</p>
                                        ...
                                        <div class="form-group">
                                            <label for="example-text-input" class="col-form-label">Court Name</label>
