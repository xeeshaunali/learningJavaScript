    ...
    <ul class="sidebar-menu" data-widget="tree">
      ...
      <li class="treeview">
        <a href="#">
          ...
          <span>Judge / Employee</span>
          <span class="pull-right-container">
            <i class="fa fa-angle-left pull-right"></i>
          </span>
        </a>
        <ul class="treeview-menu">
          <li><a href="student.php"><i class="fa fa-circle-o"></i> Judge / Employee List</a></li>
          <li><a href="course.php"><i class="fa fa-circle-o"></i> Courts</a></li>
        </ul>
      </li>
    </ul>
  </section>
